                    ...
                    <div class="box box-warning">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group col-sm-6">
                                <label>Độ bền</label>
                                <input type="text" name="pro_energy" value="{{ old('pro_energy') }}" class="form-control" placeholder="Độ bền">
                            </div>

                            <div class="form-group col-sm-6">
                                <label>Độ chịu lực</label>
                                <input type="text" name="pro_resistant" value="{{ old('pro_resistant') }}" class="form-control" placeholder="Độ chịu lực">
                            </div>
